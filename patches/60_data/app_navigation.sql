...
USING (
    ...
    SELECT 710 AS app_id, 320 AS page_id, NULL AS parent_id, NULL AS is_hidden, 'Y' AS is_reset, 420 AS order#, NULL AS col_id FROM DUAL UNION ALL
    SELECT 710 AS app_id, 322 AS page_id, 320 AS parent_id, 'Y' AS is_hidden, 'Y' AS is_reset, NULL AS order#, NULL AS col_id FROM DUAL UNION ALL
    SELECT 710 AS app_id, 340 AS page_id, NULL AS parent_id, NULL AS is_hidden, 'Y' AS is_reset, 440 AS order#, NULL AS col_id FROM DUAL UNION ALL
    SELECT 710 AS app_id, 342 AS page_id, 340 AS parent_id, 'Y' AS is_hidden, 'Y' AS is_reset, NULL AS order#, NULL AS col_id FROM DUAL UNION ALL
    SELECT 710 AS app_id, 360 AS page_id, NULL AS parent_id, NULL AS is_hidden, 'Y' AS is_reset, 460 AS order#, NULL AS col_id FROM DUAL UNION ALL
    SELECT 710 AS app_id, 400 AS page_id, NULL AS parent_id, NULL AS is_hidden, 'Y' AS is_reset, 400 AS order#, NULL AS col_id FROM DUAL UNION ALL
    SELECT 710 AS app_id, 500 AS page_id, NULL AS parent_id, NULL AS is_hidden, 'Y' AS is_reset, 500 AS order#, NULL AS col_id FROM DUAL UNION ALL
    SELECT 710 AS app_id, 510 AS page_id, 500 AS parent_id, NULL AS is_hidden, 'Y' AS is_reset, 10 AS order#, NULL AS col_id FROM DUAL UNION ALL
    SELECT 710 AS app_id, 515 AS page_id, 500 AS parent_id, NULL AS is_hidden, 'Y' AS is_reset, 15 AS order#, NULL AS col_id FROM DUAL
) s
ON (
    t.app_id = s.app_id
