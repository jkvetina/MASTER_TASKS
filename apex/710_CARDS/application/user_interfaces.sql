...
,p_navigation_list_template_id=>wwv_flow_imp.id(34014612441153815)
...
,p_nav_bar_type=>'LIST'
,p_nav_bar_list_id=>wwv_flow_imp.id(28802196659285496)  -- LIST: NAVIGATION
,p_nav_bar_list_template_id=>wwv_flow_imp.id(31684266225644159)
