...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(40347125483866233)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40347441375866235)
,p_plugin_id=>wwv_flow_imp.id(40347125483866233)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40347748620866236)
,p_plugin_id=>wwv_flow_imp.id(40347125483866233)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40348025490866237)
,p_plugin_id=>wwv_flow_imp.id(40347125483866233)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40348392991866238)
,p_plugin_id=>wwv_flow_imp.id(40347125483866233)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40348648714866239)
,p_plugin_id=>wwv_flow_imp.id(40347125483866233)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40348957562866240)
,p_plugin_id=>wwv_flow_imp.id(40347125483866233)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40349284764866241)
,p_plugin_id=>wwv_flow_imp.id(40347125483866233)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40349588728866242)
,p_plugin_id=>wwv_flow_imp.id(40347125483866233)
,p_attribute_scope=>'COMPONENT'
