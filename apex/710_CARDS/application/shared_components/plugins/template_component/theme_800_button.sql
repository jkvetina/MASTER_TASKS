...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(53216253390301098)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(56666652457654216)
,p_plugin_id=>wwv_flow_imp.id(53216253390301098)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(56667190183654216)
,p_plugin_id=>wwv_flow_imp.id(53216253390301098)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(56667712120654217)
,p_plugin_id=>wwv_flow_imp.id(53216253390301098)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(56668212360654217)
,p_plugin_id=>wwv_flow_imp.id(53216253390301098)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(56668647039654218)
,p_plugin_id=>wwv_flow_imp.id(53216253390301098)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(56669198263654218)
,p_plugin_id=>wwv_flow_imp.id(53216253390301098)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(56669665663654218)
,p_plugin_id=>wwv_flow_imp.id(53216253390301098)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(56670149252654219)
,p_plugin_id=>wwv_flow_imp.id(53216253390301098)
,p_attribute_scope=>'COMPONENT'
