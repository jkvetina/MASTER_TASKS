...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(40387302788866370)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1864759761662804613)
,p_plugin_id=>wwv_flow_imp.id(40387302788866370)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1864759206650804612)
,p_plugin_id=>wwv_flow_imp.id(40387302788866370)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40388023627866376)
,p_plugin_id=>wwv_flow_imp.id(40387302788866370)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40388333906866377)
,p_plugin_id=>wwv_flow_imp.id(40387302788866370)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40388641172866377)
,p_plugin_id=>wwv_flow_imp.id(40387302788866370)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40388961659866378)
,p_plugin_id=>wwv_flow_imp.id(40387302788866370)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40389271370866379)
,p_plugin_id=>wwv_flow_imp.id(40387302788866370)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(40388641172866377)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1864759761662804613)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40389545572866380)
,p_plugin_attribute_id=>wwv_flow_imp.id(40389271370866379)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40389910461866381)
,p_plugin_attribute_id=>wwv_flow_imp.id(40389271370866379)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40390300631866382)
,p_plugin_attribute_id=>wwv_flow_imp.id(40389271370866379)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40390719978866383)
,p_plugin_id=>wwv_flow_imp.id(40387302788866370)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(40389271370866379)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40391040231866384)
,p_plugin_id=>wwv_flow_imp.id(40387302788866370)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40391356924866385)
,p_plugin_id=>wwv_flow_imp.id(40387302788866370)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40391697376866386)
,p_plugin_id=>wwv_flow_imp.id(40387302788866370)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40391986031866387)
,p_plugin_id=>wwv_flow_imp.id(40387302788866370)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40392244732866387)
,p_plugin_attribute_id=>wwv_flow_imp.id(40391986031866387)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40392678207866388)
,p_plugin_attribute_id=>wwv_flow_imp.id(40391986031866387)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40393083416866389)
,p_plugin_attribute_id=>wwv_flow_imp.id(40391986031866387)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40393464797866390)
,p_plugin_attribute_id=>wwv_flow_imp.id(40391986031866387)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40393802393866391)
,p_plugin_id=>wwv_flow_imp.id(40387302788866370)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(40388961659866378)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1864759206650804612)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40394133380866392)
,p_plugin_id=>wwv_flow_imp.id(40387302788866370)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40394456228866393)
,p_plugin_id=>wwv_flow_imp.id(40387302788866370)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40394775810866394)
,p_plugin_id=>wwv_flow_imp.id(40387302788866370)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40395065871866395)
,p_plugin_id=>wwv_flow_imp.id(40387302788866370)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40395361751866396)
,p_plugin_id=>wwv_flow_imp.id(40387302788866370)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40395611125866397)
,p_plugin_attribute_id=>wwv_flow_imp.id(40395361751866396)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40396074157866398)
,p_plugin_attribute_id=>wwv_flow_imp.id(40395361751866396)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40396420931866399)
,p_plugin_id=>wwv_flow_imp.id(40387302788866370)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40396745758866399)
,p_plugin_attribute_id=>wwv_flow_imp.id(40396420931866399)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40397189243866400)
,p_plugin_attribute_id=>wwv_flow_imp.id(40396420931866399)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40397548562866401)
,p_plugin_attribute_id=>wwv_flow_imp.id(40396420931866399)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40397927824866402)
,p_plugin_id=>wwv_flow_imp.id(40387302788866370)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40398227778866404)
,p_plugin_attribute_id=>wwv_flow_imp.id(40397927824866402)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40398687944866405)
,p_plugin_attribute_id=>wwv_flow_imp.id(40397927824866402)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40399003630866405)
,p_plugin_attribute_id=>wwv_flow_imp.id(40397927824866402)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40399421372866406)
,p_plugin_attribute_id=>wwv_flow_imp.id(40397927824866402)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40399882974866407)
,p_plugin_attribute_id=>wwv_flow_imp.id(40397927824866402)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40400229923866409)
,p_plugin_id=>wwv_flow_imp.id(40387302788866370)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40400556502866409)
,p_plugin_attribute_id=>wwv_flow_imp.id(40400229923866409)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40400960178866411)
,p_plugin_id=>wwv_flow_imp.id(40387302788866370)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1864962813819951241)
,p_plugin_id=>wwv_flow_imp.id(40387302788866370)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
