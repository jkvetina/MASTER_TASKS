...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(40349887250866245)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1864583698669952533)
,p_plugin_id=>wwv_flow_imp.id(40349887250866245)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40350302106866249)
,p_plugin_id=>wwv_flow_imp.id(40349887250866245)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40350600832866250)
,p_plugin_id=>wwv_flow_imp.id(40349887250866245)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40350937216866251)
,p_plugin_id=>wwv_flow_imp.id(40349887250866245)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40351281233866252)
,p_plugin_id=>wwv_flow_imp.id(40349887250866245)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40351535386866253)
,p_plugin_id=>wwv_flow_imp.id(40349887250866245)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(40356158447866265)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1864583698669952533)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40351807775866254)
,p_plugin_attribute_id=>wwv_flow_imp.id(40351535386866253)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40352242526866255)
,p_plugin_attribute_id=>wwv_flow_imp.id(40351535386866253)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40352643010866255)
,p_plugin_attribute_id=>wwv_flow_imp.id(40351535386866253)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40353069992866257)
,p_plugin_id=>wwv_flow_imp.id(40349887250866245)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(40351535386866253)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40353315402866257)
,p_plugin_id=>wwv_flow_imp.id(40349887250866245)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40353642130866258)
,p_plugin_id=>wwv_flow_imp.id(40349887250866245)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40353980602866259)
,p_plugin_id=>wwv_flow_imp.id(40349887250866245)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40354216119866260)
,p_plugin_id=>wwv_flow_imp.id(40349887250866245)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40355767693866264)
,p_plugin_attribute_id=>wwv_flow_imp.id(40354216119866260)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40354530843866261)
,p_plugin_attribute_id=>wwv_flow_imp.id(40354216119866260)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40354949099866262)
,p_plugin_attribute_id=>wwv_flow_imp.id(40354216119866260)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40355328208866263)
,p_plugin_attribute_id=>wwv_flow_imp.id(40354216119866260)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40356158447866265)
,p_plugin_id=>wwv_flow_imp.id(40349887250866245)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40356406621866266)
,p_plugin_id=>wwv_flow_imp.id(40349887250866245)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40356795096866267)
,p_plugin_id=>wwv_flow_imp.id(40349887250866245)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40357048670866268)
,p_plugin_attribute_id=>wwv_flow_imp.id(40356795096866267)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(40357463706866269)
,p_plugin_attribute_id=>wwv_flow_imp.id(40356795096866267)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(40357877496866270)
,p_plugin_id=>wwv_flow_imp.id(40349887250866245)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1864716366103054036)
,p_plugin_id=>wwv_flow_imp.id(40349887250866245)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1864715774598046579)
,p_plugin_id=>wwv_flow_imp.id(40349887250866245)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1864771398268028458)
,p_plugin_id=>wwv_flow_imp.id(40349887250866245)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1864923615980899229)
,p_plugin_id=>wwv_flow_imp.id(40349887250866245)
