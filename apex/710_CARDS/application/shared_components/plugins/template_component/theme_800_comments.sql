...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(53218932174301100)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1868559202986925024)
,p_plugin_id=>wwv_flow_imp.id(53218932174301100)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(56671504676654224)
,p_plugin_id=>wwv_flow_imp.id(53218932174301100)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(56671983017654225)
,p_plugin_id=>wwv_flow_imp.id(53218932174301100)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(56672507087654225)
,p_plugin_id=>wwv_flow_imp.id(53218932174301100)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(56672999180654226)
,p_plugin_id=>wwv_flow_imp.id(53218932174301100)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(56673510460654226)
,p_plugin_id=>wwv_flow_imp.id(53218932174301100)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(56680698327654232)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1868559202986925024)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(56673921342654227)
,p_plugin_attribute_id=>wwv_flow_imp.id(56673510460654226)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(56674539654654227)
,p_plugin_attribute_id=>wwv_flow_imp.id(56673510460654226)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(56675135608654228)
,p_plugin_attribute_id=>wwv_flow_imp.id(56673510460654226)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(56675809710654228)
,p_plugin_id=>wwv_flow_imp.id(53218932174301100)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(56673510460654226)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(56676217645654229)
,p_plugin_id=>wwv_flow_imp.id(53218932174301100)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(56676716773654229)
,p_plugin_id=>wwv_flow_imp.id(53218932174301100)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(56677267916654230)
,p_plugin_id=>wwv_flow_imp.id(53218932174301100)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(56677739757654230)
,p_plugin_id=>wwv_flow_imp.id(53218932174301100)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(56678260478654230)
,p_plugin_attribute_id=>wwv_flow_imp.id(56677739757654230)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(56678899553654231)
,p_plugin_attribute_id=>wwv_flow_imp.id(56677739757654230)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(56679429778654231)
,p_plugin_attribute_id=>wwv_flow_imp.id(56677739757654230)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(56680062514654232)
,p_plugin_attribute_id=>wwv_flow_imp.id(56677739757654230)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(56680698327654232)
,p_plugin_id=>wwv_flow_imp.id(53218932174301100)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(56681138040654232)
,p_plugin_id=>wwv_flow_imp.id(53218932174301100)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(56681634496654233)
,p_plugin_id=>wwv_flow_imp.id(53218932174301100)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(56682206174654233)
,p_plugin_attribute_id=>wwv_flow_imp.id(56681634496654233)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(56682716427654234)
,p_plugin_attribute_id=>wwv_flow_imp.id(56681634496654233)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(56683335382654234)
,p_plugin_id=>wwv_flow_imp.id(53218932174301100)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1879421877694566456)
,p_plugin_id=>wwv_flow_imp.id(53218932174301100)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1879421286189558999)
,p_plugin_id=>wwv_flow_imp.id(53218932174301100)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1879476909859540878)
,p_plugin_id=>wwv_flow_imp.id(53218932174301100)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1879629127572411649)
,p_plugin_id=>wwv_flow_imp.id(53218932174301100)
