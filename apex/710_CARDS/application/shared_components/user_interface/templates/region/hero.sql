...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(40222089463865910)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40222327315865911)
,p_plug_template_id=>wwv_flow_imp.id(40222089463865910)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40222682017865911)
,p_plug_template_id=>wwv_flow_imp.id(40222089463865910)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40222948643865912)
,p_plug_template_id=>wwv_flow_imp.id(40222089463865910)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40223202275865912)
,p_plug_template_id=>wwv_flow_imp.id(40222089463865910)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40223529204865913)
,p_plug_template_id=>wwv_flow_imp.id(40222089463865910)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
