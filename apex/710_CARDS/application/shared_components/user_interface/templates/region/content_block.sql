...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(53087891631300990)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56372856378653989)
,p_plug_template_id=>wwv_flow_imp.id(53087891631300990)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56373331499653989)
,p_plug_template_id=>wwv_flow_imp.id(53087891631300990)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56373871755653989)
,p_plug_template_id=>wwv_flow_imp.id(53087891631300990)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56374341734653990)
,p_plug_template_id=>wwv_flow_imp.id(53087891631300990)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56374880743653990)
,p_plug_template_id=>wwv_flow_imp.id(53087891631300990)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56375406286653990)
,p_plug_template_id=>wwv_flow_imp.id(53087891631300990)
,p_name=>'Sub Regions'
