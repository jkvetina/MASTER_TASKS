...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(53096037705300994)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56391102642654000)
,p_plug_template_id=>wwv_flow_imp.id(53096037705300994)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56391556291654000)
,p_plug_template_id=>wwv_flow_imp.id(53096037705300994)
,p_name=>'Sub Regions'
