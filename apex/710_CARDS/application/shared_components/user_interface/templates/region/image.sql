...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(40225552730865917)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40225870291865918)
,p_plug_template_id=>wwv_flow_imp.id(40225552730865917)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40226149681865918)
,p_plug_template_id=>wwv_flow_imp.id(40225552730865917)
,p_name=>'Sub Regions'
