...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(40265132356865999)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40265451677866000)
,p_plug_template_id=>wwv_flow_imp.id(40265132356865999)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40265736665866001)
,p_plug_template_id=>wwv_flow_imp.id(40265132356865999)
,p_name=>'Tabs'
