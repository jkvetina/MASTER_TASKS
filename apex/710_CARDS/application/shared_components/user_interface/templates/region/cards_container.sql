...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(40195849749865853)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40196150259865853)
,p_plug_template_id=>wwv_flow_imp.id(40195849749865853)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40196494746865854)
,p_plug_template_id=>wwv_flow_imp.id(40195849749865853)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40196748349865854)
,p_plug_template_id=>wwv_flow_imp.id(40195849749865853)
,p_name=>'Sub Regions'
