...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(53066352699300977)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56315648961653956)
,p_plug_template_id=>wwv_flow_imp.id(53066352699300977)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56316134592653956)
,p_plug_template_id=>wwv_flow_imp.id(53066352699300977)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(56316614292653956)
,p_plug_template_id=>wwv_flow_imp.id(53066352699300977)
,p_name=>'Sub Regions'
