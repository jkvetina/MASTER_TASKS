...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(40166640587865792)
,p_theme_id=>800
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40166914084865793)
,p_page_template_id=>wwv_flow_imp.id(40166640587865792)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40167219396865794)
,p_page_template_id=>wwv_flow_imp.id(40166640587865792)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40167529563865794)
,p_page_template_id=>wwv_flow_imp.id(40166640587865792)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40167834540865795)
,p_page_template_id=>wwv_flow_imp.id(40166640587865792)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40168188348865795)
,p_page_template_id=>wwv_flow_imp.id(40166640587865792)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40168451499865796)
,p_page_template_id=>wwv_flow_imp.id(40166640587865792)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40168769679865796)
,p_page_template_id=>wwv_flow_imp.id(40166640587865792)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40169011044865796)
,p_page_template_id=>wwv_flow_imp.id(40166640587865792)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40169364536865797)
,p_page_template_id=>wwv_flow_imp.id(40166640587865792)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40169669928865797)
,p_page_template_id=>wwv_flow_imp.id(40166640587865792)
