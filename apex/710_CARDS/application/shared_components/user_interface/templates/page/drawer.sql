...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(40149467917865751)
,p_theme_id=>800
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40149741920865756)
,p_page_template_id=>wwv_flow_imp.id(40149467917865751)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40150012056865756)
,p_page_template_id=>wwv_flow_imp.id(40149467917865751)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40150377667865757)
,p_page_template_id=>wwv_flow_imp.id(40149467917865751)
