...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(40171518633865802)
,p_theme_id=>800
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40171851543865803)
,p_page_template_id=>wwv_flow_imp.id(40171518633865802)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40172168820865803)
,p_page_template_id=>wwv_flow_imp.id(40171518633865802)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40172414223865804)
,p_page_template_id=>wwv_flow_imp.id(40171518633865802)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40172732320865804)
,p_page_template_id=>wwv_flow_imp.id(40171518633865802)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40173036364865805)
,p_page_template_id=>wwv_flow_imp.id(40171518633865802)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40173358537865806)
,p_page_template_id=>wwv_flow_imp.id(40171518633865802)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40173650134865806)
,p_page_template_id=>wwv_flow_imp.id(40171518633865802)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40173974119865807)
,p_page_template_id=>wwv_flow_imp.id(40171518633865802)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40174216984865807)
,p_page_template_id=>wwv_flow_imp.id(40171518633865802)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40174559018865807)
,p_page_template_id=>wwv_flow_imp.id(40171518633865802)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(40174807677865808)
,p_page_template_id=>wwv_flow_imp.id(40171518633865802)
