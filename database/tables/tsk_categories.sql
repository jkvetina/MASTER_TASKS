CREATE TABLE tsk_categories (
    tenant_id                       VARCHAR2(64)          CONSTRAINT tsk_categories_tenant_nn NOT NULL,
    client_id                       NUMBER(10,0)          CONSTRAINT tsk_categories_client_nn NOT NULL,
    project_id                      NUMBER(10,0)          CONSTRAINT tsk_categories_project_nn NOT NULL,
    category_id                     NUMBER(10,0)          GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1000 CONSTRAINT tsk_categories_category_nn NOT NULL,
    category_name                   VARCHAR2(64)          CONSTRAINT tsk_categories_name_nn NOT NULL,
    ...
    updated_at                      DATE,
    --
    CONSTRAINT tsk_categories_ch
        CHECK (
            is_active = 'Y' OR is_active IS NULL
        ) ENABLE,
    --
    CONSTRAINT tsk_categories_default_ch
        CHECK (
    ...
    --
    CONSTRAINT tsk_categories_project_fk
        FOREIGN KEY (
            tenant_id,
            client_id,
            project_id
