CREATE TABLE tsk_card_comments (
    tenant_id                       VARCHAR2(64)          CONSTRAINT tsk_card_comments_tenant_nn NOT NULL,
    card_id                         NUMBER(10,0)          CONSTRAINT tsk_card_comments_card_nn NOT NULL,
    comment_id                      NUMBER(10,0)          GENERATED BY DEFAULT ON NULL AS IDENTITY START WITH 1000 CONSTRAINT tsk_card_comments_id_nn NOT NULL,
    ...
    --
    CONSTRAINT tsk_card_comments_card_fk
        FOREIGN KEY (
            tenant_id,
            card_id
        )
