CREATE OR REPLACE TRIGGER tsk_card_files__
FOR UPDATE OR INSERT OR DELETE ON tsk_card_files
COMPOUND TRIGGER

    c_table_name CONSTANT VARCHAR2(128) := 'TSK_CARD_FILES';
    ...
    BEGIN
        ...
        IF NOT DELETING THEN
            IF :NEW.file_id IS NULL THEN
                :NEW.file_id := tsk_file_id.NEXTVAL;
            END IF;
            --
