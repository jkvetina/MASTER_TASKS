...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(33859121557153720)
,p_theme_id=>800
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20344008034243905)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20344570282243906)
,p_page_template_id=>wwv_flow_imp.id(33859121557153720)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20345002836243906)
,p_page_template_id=>wwv_flow_imp.id(33859121557153720)
