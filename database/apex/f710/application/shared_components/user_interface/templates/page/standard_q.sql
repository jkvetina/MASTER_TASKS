...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(33867712787153724)
,p_theme_id=>800
,p_name=>'Standard Q'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20370507132243921)
,p_page_template_id=>wwv_flow_imp.id(33867712787153724)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20371017408243921)
,p_page_template_id=>wwv_flow_imp.id(33867712787153724)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20371558078243922)
,p_page_template_id=>wwv_flow_imp.id(33867712787153724)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20372044641243922)
,p_page_template_id=>wwv_flow_imp.id(33867712787153724)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20372531552243922)
,p_page_template_id=>wwv_flow_imp.id(33867712787153724)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20373076547243923)
,p_page_template_id=>wwv_flow_imp.id(33867712787153724)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20373550740243923)
,p_page_template_id=>wwv_flow_imp.id(33867712787153724)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20374095504243923)
,p_page_template_id=>wwv_flow_imp.id(33867712787153724)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20374502973243924)
,p_page_template_id=>wwv_flow_imp.id(33867712787153724)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20375010422243924)
,p_page_template_id=>wwv_flow_imp.id(33867712787153724)
