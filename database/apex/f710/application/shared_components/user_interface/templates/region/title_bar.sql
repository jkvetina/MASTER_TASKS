...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(33960265671153779)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20610710825244091)
,p_plug_template_id=>wwv_flow_imp.id(33960265671153779)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20611251305244091)
,p_plug_template_id=>wwv_flow_imp.id(33960265671153779)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20611755887244092)
,p_plug_template_id=>wwv_flow_imp.id(33960265671153779)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20612271448244092)
,p_plug_template_id=>wwv_flow_imp.id(33960265671153779)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20612704255244092)
,p_plug_template_id=>wwv_flow_imp.id(33960265671153779)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20613259182244092)
,p_plug_template_id=>wwv_flow_imp.id(33960265671153779)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20613793385244093)
,p_plug_template_id=>wwv_flow_imp.id(33960265671153779)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20614226352244093)
,p_plug_template_id=>wwv_flow_imp.id(33960265671153779)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20614702515244093)
,p_plug_template_id=>wwv_flow_imp.id(33960265671153779)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20615233605244094)
,p_plug_template_id=>wwv_flow_imp.id(33960265671153779)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20615745426244094)
,p_plug_template_id=>wwv_flow_imp.id(33960265671153779)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20616244145244094)
,p_plug_template_id=>wwv_flow_imp.id(33960265671153779)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20616722109244094)
,p_plug_template_id=>wwv_flow_imp.id(33960265671153779)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
