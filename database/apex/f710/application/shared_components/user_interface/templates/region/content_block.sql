...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(33909879148153752)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20479374638244002)
,p_plug_template_id=>wwv_flow_imp.id(33909879148153752)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20479823548244003)
,p_plug_template_id=>wwv_flow_imp.id(33909879148153752)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20480367538244003)
,p_plug_template_id=>wwv_flow_imp.id(33909879148153752)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20480823507244003)
,p_plug_template_id=>wwv_flow_imp.id(33909879148153752)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20481310379244003)
,p_plug_template_id=>wwv_flow_imp.id(33909879148153752)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(20481801147244004)
,p_plug_template_id=>wwv_flow_imp.id(33909879148153752)
,p_name=>'Sub Regions'
